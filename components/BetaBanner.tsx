export default function BetaBanner() {
  return (
    <div className="bg-vw-purple/10 border border-vw-purple/30 backdrop-blur-sm">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-2.5 text-center text-xs text-foreground/70">
